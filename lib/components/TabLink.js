...
var TabLink = function (_Component) {
    ...
    function TabLink() {
        ...
        var _this = _possibleConstructorReturn(this, (TabLink.__proto__ || Object.getPrototypeOf(TabLink)).call(this));
...
TabLink.propTypes = {
    to: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
